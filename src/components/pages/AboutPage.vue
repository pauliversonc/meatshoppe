    ...
    <div class="about__alignment">
      ...
      <div class="about__story opposite u-mt-0">
        ...
        >
          ...
          <img
            class="about__img"
            src="/images/about/alignment-1.jpg"
            alt=""
            srcset=""
          />
        </div>
      ...
      <div class="about__story">
        ...
        >
          ...
          <img
            class="about__img"
            src="/images/about/alignment-2.jpg"
            alt=""
            srcset=""
          />
        </div>
      ...
      <div class="about__story opposite u-mb-0">
        ...
        >
          ...
          <img
            class="about__img"
            src="/images/about/alignment-3.jpg"
            alt=""
            srcset=""
          />
        </div>
...
.about {
  ...
  &__cover {
    ...
    background-image: url(/images/about/about-us-xl.png);
